...
\title{Cooperation in Biological and Social Systems} % Title of the book
...
\thispagestyle{empty}
\openepigraph{\textbf{Evolution is a light which illuminates all facts, \linebreak a curve that all lines must follow.}}{Pierre Teilhard de Chardin, {\itshape The Phenomenon of Man, 1955}}
...
% Introductory general reading: Why Evolution is True, Coyne; Blind Watchmaker, Dawkins; Song of the dodo
